...
if (!(userNameInput && assessmentButton && resultDivided && tweetDivided) ) {
  throw new Error('Error');
}

// ボタンが押された時の処理
function clickedButtonForAssessment() {
  console.log('ボタンが押されました');
  // @ts-ignore
  const userName = userNameInput.value; // ユーザーの入力を取得
  ...
  // 読み込むjsファイル（Twitterが提供しているwidgets.jsファイルを読みこむ）
...
// console.assert(
//   assessment('太郎') === '太郎のいいところは発信力です。太郎がする決断にいつも助けられる人がいます。',
//   '診断結果の文章が正しくありません.'
// );
